...
type Wallet struct {
	...
	Balance       decimal.Decimal `json:"balance" gorm:"type:decimal(12,2);not null;default:0"`
	FrozenBalance decimal.Decimal `json:"frozen_balance" gorm:"type:decimal(12,2);not null;default:0"`
	TotalIncome   decimal.Decimal `json:"total_income" gorm:"type:decimal(12,2);not null;default:0"`
	TotalExpense  decimal.Decimal `json:"total_expense" gorm:"type:decimal(12,2);not null;default:0"`
